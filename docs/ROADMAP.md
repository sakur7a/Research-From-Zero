...
Current local verification counts are recorded in `docs/TESTING.md`; Chromium and MockTransport checks use fixture providers and do not close hosted release gates. The Docker image is not installed locally; the updated container workflow must run on the next push.
