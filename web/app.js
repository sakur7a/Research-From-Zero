...
function render() {
  ...
  app.innerHTML = `<aside class="sidebar">
    ...
    <div class="sidebar-bottom"><div class="local-note">${icon('leaf',20)}<strong>证据先于结论</strong><p>找到资源不等于可以复现。<br>每次判断，都留下依据。</p></div>
    <button class="nav-item" data-action="settings">${icon('settings')}<span>数据与设置</span></button><div class="sidebar-footer"><span class="online-dot"></span> 本地存储 <span>v0.1.0</span></div></div>
